        ...
        carsGrid.innerHTML = cars.map(car => `
            <div class="car-card ${car.sold ? 'sold-car' : ''}" onclick="viewCarDetails(${car.id})">
                <div class="car-image" style="background: none; padding: 0; position: relative;">
                    ...
                    ${(car.make !== 'Porsche' || car.id === 14) ? '<div class="carfax-badge"><img src="https://www.passportbmw.com/blogs/846/wp-content/uploads/2016/07/carfax.jpg" alt="CarFax" style="width: 60px; height: auto; border-radius: 4px;"></div>' : ''}
